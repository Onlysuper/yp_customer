...
import {AgentManage,AgentManageAdd,orgCodeHandle} from "@src/apis"
export default {
    name: 'pc',
    data () {
      ...
      return {
        ...
        addRules: {
          agentName: [
            { validator: agentName, trigger: 'blur' }
          ],
          agentPhone: [
            { validator: agentPhone, trigger: 'blur' }
          ],
          agentArea: [
            { validator: agentArea, trigger: 'blur' }
          ],
          frValue: [
            { validator: frValue, trigger: 'blur' }
          ],
          shValue: [
            { validator: shValue, trigger: 'blur' }
          ],
          sqValue: [
            { validator: sqValue, trigger: 'blur' }
          ],
          dqValue: [
            { validator: dqValue, trigger: 'blur' }
          ]
        },
        editform: { // 编辑合伙人信息
          agentName: '',// 合伙人名称
