  ...
  <div>
    <el-form size="small" :model="payStatusForm" ref="payStatusForm" :rules="payStatusFormRules" label-width="100px">
      ...
      <el-row>
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item class="full-width" label="行业类型" prop="taxNo" :label-width="formLabelWidth">
              <el-select @input="categoryChange" size="small" v-model="payStatusForm.category" placeholder="请选择">
                <el-option v-for="item in selectOptions.categoryOptions" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </div>
      ...
      <el-row>
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="结算信息" prop="accountType" :label-width="formLabelWidth">
              <el-select @input="accountTypeChange" size="small" v-model="payStatusForm.accountType" placeholder="请选择">
      ...
      <el-form-item label="开户银行" prop="bankName" :label-width="formLabelWidth">
        <el-select @input="bankNameChange" size="small" v-model="payStatusForm.bankName" placeholder="请选择">
          <el-option v-for="item in selectOptions.bankNameOptions" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="开户支行" prop="taxNo" :label-width="formLabelWidth">
        <el-select @input="branchNameChange" size="small" v-model="payStatusForm.branchNames" placeholder="请选择">
          <el-option v-for="item in selectOptions.branchNameOptions" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
    ...
    <div center slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="editSave('editForm')">下一步</el-button>
    </div>
  </div>
</template>
