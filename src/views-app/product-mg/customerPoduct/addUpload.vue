  ...
  <full-page class="add-goods-container page">
    ...
    <div class="add-playinfo">
      <view-radius class="uploads">
        ...
        <upload-view :label="'法人手持身份证照'" v-show="corporatePerson" class="item" :customerNo="customerNo" :upType="'APPLICANT_WITH_ID'" @result="resultMediaId" :dataKey="'identityHolderImg'" ref="identityHolderImg"></upload-view>
