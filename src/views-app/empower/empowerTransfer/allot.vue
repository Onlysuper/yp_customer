  ...
  <full-page>
    ...
    <view-radius>
      <input-wrapper>
        ...
        <mt-field @click.native="$refs.migrateTypePicker.open" type="text" label="分配方式" placeholder="请选择分配方式" :value="migrateType.name" v-readonly-ios :readonly="true" :disableClear="true">
          <i class="icon-arrow"></i>
        </mt-field>
...
export default {
  ...
  data() {
    return {
      btnDisabled: false,
      pageType: this.$route.query["type"] || "ALLOT",
